...
describe('Get and parse ethereum txns', () => {
  ...
  test('Convert ERC-20 to mainnet tokens', () => {
    expect(fromERC20ToDockTokens(web3Client, "9194775499990000000000").toString()).toBe("9194775499");
    expect(fromERC20ToDockTokens(web3Client, "19023932499990000000000").toString()).toBe("19023932499");
    expect(fromERC20ToDockTokens(web3Client, "5351643000000000000000").toString()).toBe("5351643000");
    expect(fromERC20ToDockTokens(web3Client, "1654000000000000000000").toString()).toBe("1654000000");
    expect(fromERC20ToDockTokens(web3Client, "6525911238000000000000").toString()).toBe("6525911238");
    expect(fromERC20ToDockTokens(web3Client, "46277679625000000000000").toString()).toBe("46277679625");
    expect(fromERC20ToDockTokens(web3Client, "37500000000000000000000").toString()).toBe("37500000000");
    expect(fromERC20ToDockTokens(web3Client, "84000000000000000000").toString()).toBe("84000000");
  });
});